...
<body>
  ...
  <div id="page_content">    
    ...
    <section class="toggle home"> 
      ...
      <a title="Angel Specials" style="color: #AF473C;" href="appointment_history">Appointment History</a> &gt; <?=e($title)?> 

      <!-- div container for products images starts here -->  
      <div id="service_history_container">  
        <?php require __DIR__ . '/includes/flash.inc.php'; ?>   
        <p>Name&#58; <?=e($serviceHistory[0]['first_name'])?></p>
        <p>Booking Date&#58; <?=e($serviceHistory[0]['appointment_date'])?></p>
        <p>Booking Time&#58; <?=e(substr($serviceHistory[0]['appointment_time'],0,2))?>
          <?php if(e(substr($serviceHistory[0]['appointment_time'],0,2))==12) : ?>
            pm
          <?php else : ?>
            am
          <?php endif; ?>
        </p>
        <p>Card&#58; &#120;&#120;&#120;&#120; &#120;&#120;&#120;&#120; &#120;&#120;&#120;&#120; <?=e($serviceHistory[0]['service_card'])?></p>
        <table>
        <tr>
          <th>Service Name</th>
          <th>Category</th>
        ...
        <?php for($i=0;$i<count($serviceHistory);$i++) : ?>
          <tr>
            <td><?=e($serviceHistory[$i]['service_name'])?></td>
            <td><?=e($serviceHistory[$i]['service_category'])?></td>
            <td>&#36;<?=e($serviceHistory[$i]['service_price'])?></td>
            <td><?=e($serviceHistory[$i]['service_quantity'])?></td>
            <td>&#36;<?=e($serviceHistory[$i]['service_totalcost'])?></td>
          </tr>
        <?php endfor; ?>
        </table>  
        <table id="booked_cost">
          <tr>
            ...
            <td>&#36;<?=e($serviceHistory[0]['total_appointment_cost'])?></td>
          </tr>
          <tr>
            <th>GST Applied (5&#37;)</th>
            <td>&#36;<?=e($serviceHistory[0]['gst_cost'])?></td>
          </tr>
          <tr>
            <th>Total Cost</th>
            <td>&#36;<?=e($serviceHistory[0]['total_cost'])?></td>
          </tr>
        </table> 
